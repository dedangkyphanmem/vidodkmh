...
<body onload="OnLoad()"  class="HorizontalTemplate">
    <!--header-->
    <div class="bar"></div>
    <div style="width:100%; margin:0; padding:0 auto;">
    ...
    <div class="bar"></div>
    <div style="width:100%; height:30px; padding:0 auto;" >
...
<div align="center" style="color: rgb(85, 85, 85);">Website được x&acirc;y dựng dựa tr&ecirc;n <a href="htt(08) 38.337.982</td>
        </tr>
    </tbody>
</table>
...
<table cellpadding="0" cellspacing="0">
    <tbody>
        <tr>
            ...
            <td class="tdContainerSeparator">
                <img src="/Portals/_default/Containers/VD-News/../../Images/spacer.gif" class="spacer" alt="" />
            </td>
        </tr>
    </tbody>
</table>
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" class="tdCopyRight">
                                                &nbsp;Bản quyền thuộc<span id="dnn_dnnCOPYRIGHT_lblCopyright" class="dnnCopyright"> Trường Cao Đẳng Viễn Đông</span>
