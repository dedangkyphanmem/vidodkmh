...
namespace vidoSolution.Module.DomainObject
{
    ...
    [Persistent("TkbClassroom")]
    public class TkbClassroom : BaseObject
    {

        private Semester semester;
        [Association("Semester-TkbClassroom", typeof(Semester))]
        ...
        public TkbClassroom(Session session) : base(session) { }
